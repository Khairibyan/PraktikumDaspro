...
public class nestedUjianSkripsi16 {
    public static void main(String[] args) {
        ...
        System.out.println("Masukan jumlah loq bimbingan Pembimbing 1: ");
        int bimbinganP1 = sc.nextInt();
        System.out.println("Masukan jumlah loq bimbingan Pembimbing 2: ");
        ...
        if (bebasKompen.equalsIgnoreCase("Ya")) {
            if (bimbinganP1 >= 8 && bimbinganP2 >= 4) {
                ...
                pesan = "Gagal Log bimbingan Pembimbing P1 kurang dari 8 kali dan P2 kurang dari 4 kali";
